...
<main>
    <section class="contactsHome section bgDark bgFixed">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="mainTitle lightTitle">
                        <span class="sectionTitle"><?php string_translate('We help you solve complex business problems<br/>with technology solutions', 'Мы помогаем вам решать сложные бизнес-проблемы<br> с помощью технологических решений'); ?></span>
                        <p class="sectionSubTitle"><?php the_title(); ?>
                            <span class="shadowText"><?php string_translate('Write us', 'Напишите нам'); ?></span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="careerBlock">
                <div class="row">
                    <div class="col-12">
                        <div class="mainTitle lightTitle">
                            <span class="sectionTitle"><?php string_translate('We create the most useful <br> sites and applications around the world', 'Создаем максимально полезные<br> сайты и приложения по всему миру'); ?></span>
                            <h1 class="sectionSubTitle"><?php string_translate('Career', 'Карьера'); ?></h1>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-xl-4 offset-xl-1">
                        <div class="slogan">
                            <p><?php string_translate('We are always <b> open </b> to new professional employees. If you are a <b> talented </b> programmer, marketer or copywriter, <b> send us your resume </b>.', 'Мы всегда <b>открыты</b> для новых профессиональных сотрудников. Если вы <b>талантливый</b> программист, маркетолог или копирайтер, <b>присылайте нам ваше резюме</b>.'); ?></p>
                            <a href="#" class="mainBtn careerPopup"><?php string_translate('Send CV', 'Отправить резюме'); ?><span class="decorUnderline"></span></a>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7">
                        <div class="mapBlock">
                            <svg class="svgIcon map">
